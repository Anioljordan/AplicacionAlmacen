...
CREATE TABLE `usuari` (
  ...
  `esManager` enum('MANAGER','VENEDOR') NOT NULL,
...
INSERT INTO `usuari` VALUES ('Jesuscristo','abc.123','MANAGER'),('Kilito','abc.123','VENEDOR'),('Neusri','abc.123','MANAGER'),('Rusk','abc.123','VENEDOR'),('Yoseph','abc.123','MANAGER');
